...
description: "정보처리기사 22회 실기 기출을 공부하며 형상관리, 디자인 패턴, SQL, 테스트 개념을 시험 대비 관점으로 정리한 학습 기록입니다."
experience_note: "정보처리기사 실기 기출을 직접 풀며 반복해서 헷갈린 개념을 시험 대비용으로 다시 묶고, 암기 팁과 구분 기준을 남긴 글입니다."
---

# 정보처리기사 22회 실기 기출 정리

이 글은 정보처리기사 실기 기출을 공부하면서 자주 헷갈렸던 개념을 한곳에 모아둔 학습 기록이다. 단순히 정답만 옮기기보다, 형상관리나 디자인 패턴처럼 비슷한 용어가 많은 영역을 시험장에서 구분할 수 있도록 암기 기준과 흐름을 함께 정리했다.
